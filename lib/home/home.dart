...
class HomeScreenState extends State<HomeScreen> {
  ...
  AssignSubscription() {
    subscription = Connectivity().onConnectivityChanged.listen(ConnectionListener);
  }
    ...
    return SafeArea(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              elevation: 0.0,
              title: const Text('Ghi chú của tôi', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black),),
                                  ...
                                  children: [
                                    ListTile(
                                      leading: const CircleAvatar(
                                        backgroundColor: Color.fromARGB(255,68,196,140),
                                        child: Icon(Icons.turned_in_not_outlined, color: Colors.white,),
                                      ),
                                      title: Text(listofnote[index].title, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                                      subtitle:Text(listofnote[index].date_created, style: const TextStyle(fontSize: 12, color: Colors.grey),),
                                    ),
                                    Container(
                                      margin: EdgeInsets.fromLTRB(3, 0, 3, 0),
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(8.0),
                                        child: (listofTitleImage[index]).path == '' ? null : Image.file(listofTitleImage[index], width: 330, height: 200, fit: BoxFit.cover,)
                                      ),
                                    ),
                                    Container(
